...
InstallMethod( CategoryOfArrows,
  ...
  function( C )
    ...
    finalize_category := ValueGlobal( "FinalizeCategory" );
    ...
    AddColiftingObject( arrows,
      function( F )
        ...
        mor_vals := [ MorphismBetweenDirectSums( [ [ IdentityMorphism( obj_vals[ 2 ] ) ], [ mor_vals[ 1 ] ] ] ) ];
    ...
    if finalize_category = false then
        return arrows;  
    fi;
